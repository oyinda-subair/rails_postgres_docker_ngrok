...
menu1 = SecretMenuItem.create(menu_name: 'Chipotle Nachos', restaurant_name: 'Chipotle',
  menu_description: 'Build a plate of nachos with all of your favorite fixings')
menu2 = SecretMenuItem.create(menu_name: 'Starbucks butterbeer Frappuccino', restaurant_name: 'Starbucks',
  menu_description: 'Combine three pumps of toffee nut syrup and three pumps of caramel with a Crème Frappuccino base')
menu3 = SecretMenuItem.create(menu_name: 'Skittles', restaurant_name: 'Jamba Juice',
